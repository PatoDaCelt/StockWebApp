...
export function LoginTemplate() {
  ...
  return (
    <Container >
      {/* Logo y Banner lateral */}
      <div className="contentLogo">
        <img src={logo}></img>
        <span>Gator Stock</span>
      </div>
      ...
      <div className="contentCard">
        <div className="card">
          {/* Validador de Registro cuenta */}
          {
            state && <RegistrarAdmin setState={() => setState(!state)} />
          }

          <Titulo>Gator Stock</Titulo>
          ...
          <form onSubmit={handleSubmit(iniciar)}>
            {/* Input Email */}
            <InputText icono={<variables.iconoemail />}>
              <input
            ...
            {/* Input Pass */}
            <InputText icono={<variables.iconopass />}>
              <input
                className="form__field"
                type="password"
            ...
            {/* Botones */}
            <ContainerBtn>
              <Btnsave titulo="Iniciar" bgcolor="#6ba3be" />
              <Btnsave
